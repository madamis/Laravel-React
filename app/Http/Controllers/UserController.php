...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $usersQuery->orderBy($order_field, $order_direction);

        $users = $usersQuery->paginate(10)->onEachSide(1);
    ...
    public function destroy(User $user)
    {
        $name = $user->name;
        $user->delete();
        return to_route('user.index')->with('success',"$name was successfully deleted");
    }
}
